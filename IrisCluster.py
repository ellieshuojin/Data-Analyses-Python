...
# K-means clustering: produces k cluster of similar sizes. This algorithm starts starts by choosing K centroids in the feature space, defining the centers of k clusters. Then it assigns each observation to a cluster by minimizing the distance between the observation and a centroid.
